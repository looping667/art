...
// Anti-AI-look block: pushes output away from digital/photographic/CGI aesthetic
const ANTI_AI =
  "This is a real handmade oil painting on canvas. NOT a photograph. NOT a 3D render. NOT CGI. NOT digital art. NOT AI-generated imagery. Avoid hyper-smooth gradients, perfect symmetry, and airbrushed finishes. Include the gentle organic irregularities of paint laid down by a human hand.";

// Physical texture for free style (named styles have their own technique instructions)
const PAINTING_TEXTURE =
  "The surface shows physical painting texture: visible brushstrokes with varying thickness, subtle canvas weave showing through thin paint areas, slight impasto in highlights, soft blended edges between color areas.";
...
export function buildFinalPrompt(
  ...
  // Named style — template already contains its own technique/palette/lighting.
  // We only append the anti-AI block (no PAINTING_TEXTURE to avoid conflicts
  // with styles that forbid visible brushwork, e.g. Boucher).
  const template =
